...
/* package pokerequity-0.1.0.0 */
#ifndef VERSION_pokerequity
#define VERSION_pokerequity "0.1.0.0"
#endif /* VERSION_pokerequity */
#ifndef MIN_VERSION_pokerequity
#define MIN_VERSION_pokerequity(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_pokerequity */
...
#define CURRENT_COMPONENT_ID "pokerequity-0.1.0.0-FcpO3VRvLMt1swXKLxyFHL-poker"
